...
def main():
    ...
    p1.add_argument("r03", help="r03 方案：r03_results/ 目录（块级，推荐，零拼接）或 r03_plan.md（整段，兼容）")
    ...
    p5.add_argument("-o", dest="out", default=None, help="输出 r03_plan.md（默认 r03 目录上级 reflow/r03_plan.md）")
    p5.add_argument("--chunks", default=None, help="chunks 骨架目录（可选，缺块检测）")
    ...
    if args.cmd == "reflow":
        ...
        out = args.out or str(Path(args.r03_dir).parent / "r03_plan.md")
        sys.exit(join_r03(args.r03_dir, out, args.chunks))
