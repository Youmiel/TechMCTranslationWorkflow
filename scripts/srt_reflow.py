...
def main():
    ...
    p1.add_argument("--anchored", dest="anchored", default=None, help="锚定明细 JSON（默认 r03 同目录 r03_anchored.json）")
    ...
    if args.cmd == "reflow":
        ...
        anchored = args.anchored or str(Path(args.r03).parent / "r03_anchored.json")
        reflow(args.r03, args.srt, out, alert, anchored, args.snap_ms)
